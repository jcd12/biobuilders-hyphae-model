...
def get_parser():
    ...
    parser.add_argument("-fieldtype", type=str, dest="fieldtype", default="g",
                        help="Substrate field type. Choose whether to use a uniform field (u) or a radial gradient field (g).")
    parser.add_argument("-source", type=bool, dest="source", default=False,
                        help="Choose whether to have an infinite substrate source at the edge of the simulation area.")
...
def main(args):
    ...
    dir_name = plot_for_animation(snapshots, St_snapshots, S0, dirname='ATCC1015', r=r, tstep=tstep, max_time = i)
